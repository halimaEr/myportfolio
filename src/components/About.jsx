  ...
  return (
    <Tilt className='xs:w-[250px] w-full'>
      <motion.div
        ...
        className='green-pink-gradient p-[1px] rounded-[12px] shadow-card'
      >
        <div
          options={{
            max: 25,
          ...
          className='bg-tertiary rounded-[20px] py-5 px-12 min-h-[150px] flex justify-evenly items-center flex-co'
